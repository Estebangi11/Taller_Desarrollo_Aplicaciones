...
<head>
    ...
    <style>
        ...
        /* ===== FORZAR COLORES SOBRE BOOTSTRAP ===== */

.btn-primary,
.bg-primary {
    background-color: #6b7280 !important; /* plomo */
