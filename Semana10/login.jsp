...
<html lang="es">
    <head>
        ...
        <style>
            :root {
                --academic-primary: #37474f; /* Plomo/Gris Oscuro */
            ...
            .hero-section {
                background: linear-gradient(135deg, rgba(55, 71, 79, 0.95), rgba(69, 90, 100, 0.8)),
            ...
            <div class="row h-100">
                ...
                <div class="col-lg-7 hero-section">
                    <div class="hero-content">
                        ...
                        <h1 class="academic-title">Universidad Peruana los Andes<br> </h1>
                        ...
                        <ul class="feature-list">
                            ...
                            <li class="feature-item">
                                ...
                                <div>Datos Confiables e instantaneos</div>
                            </li>
                            <li class="feature-item">
                                <div class="feature-icon"><i class="bi bi-archive"></i></div>
                                <div>Seguridad e Innovacion</div>
                            </li>
                        </ul>
                    </div>
